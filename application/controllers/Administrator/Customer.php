    ...
    function getCustomerLedger()
    {
        ...
        $payments = $this->db->query("
            ...
            select
                'c' as sequence,
                bc.id as id,
                bc.csubmit_date as date,
                concat('Received - ', 'Bank - ', bc.bank_name, ' - ', bc.branch_name, ' - ', bc.check_no, ' ', bc.note) as description,
                0.00 as bill,
                bc.check_amount as paid,
                0.00 as due,
                0.00 as returned,
                0.00 as paid_out,
                0.00 as balance
